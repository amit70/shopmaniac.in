...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive; color:#111;"><b>OS</b></p>
   ...
   $i1=0;
   $i2=0;
  $qry1=mysql_query("select * from products where subname='mobiles' and brand='micromax' and category='android'");
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Screen Size</b></p>
 ...
 $prodname4=array();
 $i1=0;
  $qry4=mysql_query("select * from products where subname='mobiles' and brand='micromax' and size BETWEEN 3 AND 3.9");
  while($row = mysql_fetch_array($qry4))
{
 ...
 $count4=count($prodname1);
  ...
  $qry4=mysql_query("select * from products where subname='mobiles' and brand='micromax' and size Between 4 AND 4.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 $count5=count($prodname2);
     ...
     $qry4=mysql_query("select * from products where subname='mobiles' and brand='micromax' and size BETWEEN 5 AND 5.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 $qry4=mysql_query("select * from products where subname='mobiles' and brand='micromax' and size BETWEEN 6 AND 6.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 echo "<option value=\"5-5.9\">5-5.9($count6)</option>";
  echo "<option value=\"6-6.9\">6-6.9($count7)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%;font-family:'Comic Sans MS', cursive;"><b>Brand</b></p>
  ...
  <?php
  echo "<option value=\"micromax\">Micromax ($count6)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Price</b></p>
  ...
  $prodname1=array();
   ...
   $i1=0;
   $i2=0;
  $qry300=mysql_query("select * from products where subname='mobiles' and brand='micromax' and discprice between 20000 and 30000");
...
$qry300=mysql_query("select * from products where subname='mobiles' and brand='micromax' and discprice between 10001 and 20000");
     while($row = mysql_fetch_array($qry300))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $count3001=count($prodname2);
  ...
  $qry0=mysql_query("select * from products where subname='mobiles' and brand='micromax' and discprice between 0 and 10000");
     while($row = mysql_fetch_array($qry0))
{
 ...
 $count0=count($prodname3);
   ...
   $qry0=mysql_query("select * from products where subname='mobiles' and brand='micromax' and discprice between 30001 and 40000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $count302=count($prodname4);
  ...
  echo "<option value=\"30001-40000\">30001-40000($count302)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Color</b></p>
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry8=mysql_query("select * from products where subname='mobiles' and brand='micromax' and color='white'");
...
$qry8=mysql_query("select * from products where subname='mobiles' and brand='micromax' and color='black'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='mobiles' and brand='micromax' and color='blue'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='mobiles' and brand='micromax' and color='grey'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $count83=count($prodname4);
  ...
  echo "<option value=\"grey\">Grey($count83)</option>";
  ?>
</select>
</div>
...
$aaa=mysql_connect("localhost","root","system");
mysql_select_db("eshop",$aaa);
$qry=mysql_query("select * from products where subname='mobiles' and brand='micromax'");
while($row = mysql_fetch_array($qry))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$i=0;	
$flag=0;
	$fetch=mysql_query("select * from products where subname='mobiles' and brand='micromax'");
