...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1013\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">Cancel Order</p>
<hr/>
1. Shopmaniac.in has the right to cancel order if the product ordered by the customer is not in stock or &nbsp;&nbsp &nbsp;&nbsp out of stock.<br/><br />
2. Amount will be fully refundable to the customer in case the payment is made through Debit /Credit &nbsp;&nbsp;&nbsp;&nbsp;Card or Net Banking .
<br/><br />
3. Shopmaniac.in also provides the facility of cancel order to the customer.<br/><br />
4. The Customer needs to call our toll-free number() in the next 24 hours from the order date to cancel &nbsp;&nbsp;&nbsp;&nbsp;the order<br/><br /> 
5. The Customer needs to provide the order-Id which he may get once an order is made or get it from &nbsp;&nbsp;&nbsp;&nbsp;myorder section of myaccount in order to cancel order.</br></br>
6. IF time exceeds more than 24 hours than shopmaniac.in is not responsible for the cause. 
</div>
</div>
