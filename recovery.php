...
<form action="recovery1.php" name="resetpass" id="resetpass" method="post">
<input type="radio" name="reset" id="email1" style="font-family:'Comic Sans MS', cursive; position:absolute; left:5%; top:37%;"><p style="position:absolute; left:10%; top:32%; font-family:'Comic Sans MS', cursive;">Email a link to Reset Password <?php
  echo "<p style=\"position:absolute; left:40%; top:34%; color:#acacac; font-size:75%;\">($email)</p>";
?></p>
