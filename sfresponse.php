...
<form method="POST" action="http://localhost/shopmaniac/check.php"  name="login123">
  ...
  <td><?php 
  echo "<input type=\"text\" name=\"email23\" id=\"email123\">";
  ?></td>
  </tr>
  <tr>
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"9\" />";
  ?>
...
if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN    $arr[0] AND $arr[1] and  category='$cat' and color='$col' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN $arr[0] AND $arr[1] and  category='$cat' and color='$col' and size='$size1' and brand='$brand1'";
	$test=1;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and size='$size1' and brand='$brand1'";
	$test=2;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and category='$cat' and color='$col' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and category='$cat' and color='$col' and size='$size1' and brand='$brand1'";
	$test=3;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN    $arr[0] AND $arr[1] and category='$cat' and color='$col' and size='$size1'";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN $arr[0] AND $arr[1] and category='$cat' and color='$col' and size='$size1'";
	$test=4;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN    $arr[0] AND $arr[1] and category='$cat' and color='$col' and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN    $arr[0] AND $arr[1] and category='$cat' and color='$col' and brand='$brand1'";
	$test=5;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN    $arr[0] AND $arr[1] and color='$col' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and color='$col' and size='$size1' and brand='$brand1'";
	$test=6;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and color='$col' and brand='$brand1'";
	$qry2="select count(*) from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and color='$col' and brand='$brand1'";
	$test=7;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['color'],"Choose Color")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='slippers' and size='$size1' and  price BETWEEN  $arr[0] AND $arr[1] and color='$col'";
	$qry2="select count(*) from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and size='$size1' and color='$col'";
	$test=8;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and color='$col' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and  color='$col' and size='$size1' and brand='$brand1'";
	$test=9;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and size='$size1' and brand='$brand1'";
	$test=10;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and color='$col'";
	$qry2="select count(*) from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and color='$col'";
	$test=11;
}
else if(strcmp($_POST['category'],"Choose Category")!=0&& strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and  category='$cat' and color='$col' and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and  category='$cat' and color='$col' and brand='$brand1'";
	$test=12;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and brand='$brand1'";
	$qry2="select count(*) from products  where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and brand='$brand1'";
	$test=13;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and  category='$cat' and color='$col' and size='$size1'";
	$qry2="select count(*) from products where subname='slippers' and   category='$cat' and color='$col' and size='$size1'";
	$test=14;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and size='$size1'";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and size='$size1'";
	$test=15;
}
...
else if(strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and color='$col'";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and color='$col'";
	$test=16;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and  color='$col' and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and  color='$col' and brand='$brand1'";
	$test=17;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['size1'],"Choose Size")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and  size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and  size='$size1' and brand='$brand1'";
	$test=18;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and brand='$brand1'";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1] and brand='$brand1'";
	$test=19;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and  category='$cat' and color='$col'";
	$qry2="select count(*) from products where subname='slippers' and  category='$cat' and color='$col'";
	$test=20;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers'  and price BETWEEN $arr[0] AND $arr[1] and  category='$cat'";
	$qry2="select count(*) from products where subname='slippers'  and price BETWEEN $arr[0] AND $arr[1] and  category='$cat'";
	$test=21;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and  category='$cat' and size='$size1'";
	$qry2="select count(*) from products where subname='slippers' and  category='$cat' and size='$size1'";
	$test=22;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1]  and size='$size1'";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN  $arr[0] AND $arr[1]  and size='$size1'";
	$test=23;
}
else if( strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='slippers' and  color='$col' and size='$size1'";
	$qry2="select count(*) from products where  subname='slippers' and  color='$col' and size='$size1'";
	$test=24;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 )
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='slippers' and category='$cat' and brand='$brand1'";
	$qry2="select count(*) from products  where subname='slippers' and category='$cat' and brand='$brand1'";
	$test=25;
}
...
else if(strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where color='$col' and subname='slippers'";
	$qry2="select count(*) from products where color='$col' and subname='slippers'";
	$test=27;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where brand='$brand1' and subname='slippers'";
	$qry2="select count(*) from products where brand='$brand1' and subname='slippers'";
	$test=28;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where size='$size1' and subname='slippers'";
	$qry2="select count(*) from products where size='$size1' and subname='slippers'";
	$test=29;
}
else if(strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='slippers' and price BETWEEN $arr[0] AND $arr[1]";
	$qry2="select count(*) from products where subname='slippers' and price BETWEEN $arr[0] AND $arr[1]";
	$test=30;
}
else if(strcmp($_POST['category'],"Choose Category")!=0)
{
	$cat=$_POST['category'];
	$qry1="select * from products where category='$cat' and subname='slippers'";
	$qry2="select count(*) from products where category='$cat' and subname='slippers'";
	$test=31;
}
else if("Choose Category"==0 && "Choose Size"==0 && "Choose Brand"==0 && "Price Range"==0 && "Choose Color"==0)
{
	$qry1="select * from products where subname='slippers' ";
	$qry2="select count(*) from products where subname='slippers' ";
	$test=32;
}
?>
<form action="http://localhost/shopmaniac/sfresponse.php" method="POST" name="filter" id="filter">
...
else if(strcmp($cat,"slippers")==0)
{
	echo "<option>Choose Category</option>
  <option value=\"slippers\" selected=\"selected\">SLIPPERS</option>
  <option value=\"flip flops\">FLIP FLOPS</option>";
}
else if(strcmp($cat,"flip flops")==0)
{
	echo "<option>Choose Category</option>
  <option value=\"slippers\">SLIPPERS</option>
  <option value=\"flip flops\" selected=\"selected\">FLIP FLOPS</option>";
}
...
echo "<p style=\"position:absolute; left:0%; top:1%; font-family:'Comic Sans MS', cursive; font-weight:bold; font-size:150%;\">MEN'S MENS SLIPPERS N FLIPFLOPS($count)</p><hr style=\"position:absolute; left:0%; top:85%; width:96%;\"/>";
?>
</div>
...
echo "</form> ";
		...
		echo "<div style=\" width:19.2%;height:72%; background-color:#fafafa; position:absolute; top:".$t."%; left:".$l."%; \">";
