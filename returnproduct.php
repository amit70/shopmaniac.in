...
<title>Return Product : Shopmaniac.in</title>
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1008\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">Return Product</p>
<hr/>
The Detail Procedure to return a Product are as follows:-<br /><br />
1. &nbsp;Go to myorder section of myaccount where you will find a return link.<br /><br />
2. When you will click on the return link you will get a  return window containing the product details as &nbsp;&nbsp;&nbsp;&nbsp;well as a return id .<br /><br />
3. When  you will click on Confirm return the product details will appear in your Returns Section of &nbsp;&nbsp;&nbsp;&nbsp;myaccount with a status pending.<br /><br />
4. You will then have to return the product to our office address by any courier of your choice.<br /><br />
5. When the product is received by us it will go through a quality check by our quality team .<br /><br />
6. When your returned product is found to be in original condition you will be given  your money in the &nbsp;&nbsp;&nbsp;&nbsp;form of credits along with shipping charge of Rs100/- if the issue is from your side .<br /><br />
7. The credits then can be used by you for your further shopping.<br /><br />
8. If the issue is from our side you wil get a full return of money in the next 12-15 days from the date of &nbsp;&nbsp;&nbsp;&nbsp;order if payment is made through credit card,debit card,net banking or cash on delivery.<br /><br />
</div>
</div>
