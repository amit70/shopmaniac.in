...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive; color:#111;"><b>OS</b></p>
   ...
   $i1=0;
   $i2=0;
  $qry1=mysql_query("select * from products where dept='mobiles&tablets' and category='android'");
...
$count1=count($prodname1);
 $qry1=mysql_query("select * from products where dept='mobiles&tablets' and category='windows'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where dept='mobiles&tablets' and category='blackberry OS 7.0'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$count3=count($prodname3);
$qry1=mysql_query("select * from products where dept='mobiles&tablets' and category='blackberry OS 7.1'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$count4=count($prodname4);
$qry1=mysql_query("select * from products where dept='mobiles&tablets' and category='blackberry OS 10'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$count5=count($prodname5);

$qry1=mysql_query("select * from products where dept='mobiles&tablets' and category='iOS 5'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$count6=count($prodname6);
$qry1=mysql_query("select * from products where dept='mobiles&tablets' and category='iOS 6'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$count7=count($prodname7);
$qry1=mysql_query("select * from products where dept='mobiles&tablets' and category='asha software platform 1.0'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$count8=count($prodname8);
 ...
 <?php 
 echo "<option value=\"android\" >Android($count1)</option>";
 echo "<option value=\"windows\" >Windows($count2)</option>";
  echo "<option value=\"blackberry OS 7.0\" >Blackberry OS 7.0($count3)</option>";
  echo "<option value=\"blackberry OS 7.1\" >Blackberry OS 7.1($count4)</option>";
  echo "<option value=\"blackberry OS 10\" >Blackberry OS 10($count5)</option>";
  echo "<option value=\"iOS 5\" >iOS 5($count6)</option>";
  echo "<option value=\"iOS 6\" >iOS 6($count7)</option>";
  echo "<option value=\"asha software platform 1.0\" >Asha Platform 1.0($count8)</option>";
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Screen Size</b></p>
 ...
 $prodname8=array();
 $i1=0;
    $qry4=mysql_query("select * from products where dept='mobiles&tablets' and size BETWEEN 2 AND 2.9");
  while($row = mysql_fetch_array($qry4))
{
 ...
 $countsize1=count($prodname1);
     $qry4=mysql_query("select * from products where dept='mobiles&tablets' and size BETWEEN 3 AND 3.9");
  while($row = mysql_fetch_array($qry4))
{
	$name= $row['pname'];
	$stock=$row['stock'];
 ...
 $countsize2=count($prodname2);
      $qry4=mysql_query("select * from products where dept='mobiles&tablets' and size BETWEEN 4 AND 4.9");
  while($row = mysql_fetch_array($qry4))
{
	$name= $row['pname'];
	$stock=$row['stock'];
 ...
 $countsize3=count($prodname3);
      $qry4=mysql_query("select * from products where dept='mobiles&tablets' and size BETWEEN 5 AND 5.9");
  while($row = mysql_fetch_array($qry4))
{
	$name= $row['pname'];
	$stock=$row['stock'];
 ...
 $countsize4=count($prodname4);
   $qry4=mysql_query("select * from products where dept='mobiles&tablets' and size BETWEEN 6 AND 6.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 $countsize5=count($prodname5);
 $qry4=mysql_query("select * from products where dept='mobiles&tablets' and size BETWEEN 7 AND 7.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 $countsize6=count($prodname6);
 

  $qry4=mysql_query("select * from products where dept='mobiles&tablets'  and size Between 8 AND 8.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 $countsize7=count($prodname7);
 
     $qry4=mysql_query("select * from products where dept='mobiles&tablets' and size BETWEEN 9 AND 9.9");
  while($row = mysql_fetch_array($qry4))
{
	$name= $row['pname'];
	$stock=$row['stock'];
 ...
 <?php
 echo "<option value=\"2-2.9\">2-2.9($countsize1)</option>";
 echo "<option value=\"3-3.9\">3-3.9($countsize2)</option>";
 echo "<option value=\"4-4.9\">4-4.9($countsize3)</option>";
 echo "<option value=\"5-5.9\">5-5.9($countsize4)</option>";
 echo "<option value=\"6-6.9\">6-6.9($countsize5)</option>";
  echo "<option value=\"7-7.9\">7-7.9($countsize6)</option>";
 echo "<option value=\"8-8.9\">8-8.9($countsize7)</option>";
 echo "<option value=\"9-9.9\">9-9.9($countsize8)</option>";
...
<div style="position:absolute; left:39.5%; top:2%; height:96%; width:0.3%; background-color:#F1F1F1;">
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry6=mysql_query("select * from products where dept='mobiles&tablets' and brand='samsung'");
 while($row = mysql_fetch_array($qry6))
{
 ...
 $countbrand1=count($prodname1);
 $qry6=mysql_query("select * from products where dept='mobiles&tablets' and brand='nokia'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countbrand2=count($prodname2);
   $qry6=mysql_query("select * from products where dept='mobiles&tablets' and brand='micromax'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countbrand3=count($prodname3);
 
 $qry6=mysql_query("select * from products where dept='mobiles&tablets' and brand='sony'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countbrand4=count($prodname4);
 
 $qry6=mysql_query("select * from products where dept='mobiles&tablets' and brand='htc'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countbrand5=count($prodname5);
 $qry6=mysql_query("select * from products where dept='mobiles&tablets' and brand='blackberry'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countbrand6=count($prodname6);
 $qry6=mysql_query("select * from products where dept='mobiles&tablets' and brand='apple'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
<p style="position:absolute; left:10%; top:3%;font-family:'Comic Sans MS', cursive;"><b>Brand</b></p>
  ...
  <?php
  echo "<option value=\"samsung\">Samsung ($countbrand1)</option>";
   echo "<option value=\"nokia\">Nokia ($countbrand2)</option>";
	echo "<option value=\"micromax\">Micromax ($countbrand3)</option>";
	 echo "<option value=\"sony\">Sony ($countbrand4)</option>";
	    echo "<option value=\"htc\">HTC ($countbrand5)</option>";
		  echo "<option value=\"blackberry\">BlackBerry ($countbrand6)</option>";
		    echo "<option value=\"apple\">Apple ($countbrand7)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Price</b></p>
 ...
 $qry0=mysql_query("select * from products where dept='mobiles&tablets' and discprice between 0 and 10000");
     while($row = mysql_fetch_array($qry0))
{
 ...
 $countprice1=count($prodname1);
 
 $qry300=mysql_query("select * from products where dept='mobiles&tablets' and discprice between 10001 and 20000");
     while($row = mysql_fetch_array($qry300))
{
 ...
 $countprice2=count($prodname2);
 
 $qry300=mysql_query("select * from products where dept='mobiles&tablets' and discprice between 20001 and 30000");
     while($row = mysql_fetch_array($qry300))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$countprice3=count($prodname3);

   $qry0=mysql_query("select * from products where dept='mobiles&tablets' and discprice between 30001 and 40000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countprice4=count($prodname4);
 
 $qry0=mysql_query("select * from products where dept='mobiles&tablets' and discprice between 40001 and 50000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countprice5=count($prodname5);
 $qry0=mysql_query("select * from products where dept='mobiles&tablets' and discprice between 50001 and 60000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countprice6=count($prodname6);
  ...
  <?php
  echo "<option value=\"0-10000\">0-10000($countprice1)</option>";
  echo "<option value=\"10001-20000\">10001-20000($countprice2)</option>";
  echo "<option value=\"20001-30000\">20001-30000($countprice3)</option>";
  echo "<option value=\"30001-40000\">30001-40000($countprice4)</option>";
    echo "<option value=\"40001-50000\">40001-50000($countprice5)</option>";
	echo "<option value=\"50001-60000\">50001-60000($countprice6)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Color</b></p>
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry8=mysql_query("select * from products where dept='mobiles&tablets'  and color='white'");
   while($row = mysql_fetch_array($qry8))
{
 ...
 $countcolor1=count($prodname1);

$qry8=mysql_query("select * from products where dept='mobiles&tablets' and color='black'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countcolor2=count($prodname2);
 
 $qry8=mysql_query("select * from products where dept='mobiles&tablets' and color='blue'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countcolor3=count($prodname3);
 $qry8=mysql_query("select * from products where dept='mobiles&tablets' and color='red'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countcolor4=count($prodname4);
 $qry8=mysql_query("select * from products where dept='mobiles&tablets' and color='green'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countcolor5=count($prodname5);
 $qry8=mysql_query("select * from products where dept='mobiles&tablets' and color='yellow'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countcolor6=count($prodname6);
  ...
  <?php
  echo "<option value=\"white\">White($countcolor1)</option>";
  echo "<option value=\"black\">Black($countcolor2)</option>";
  echo "<option value=\"blue\">Blue($countcolor3)</option>";
  echo "<option value=\"red\">Red($countcolor4)</option>";
	  echo "<option value=\"green\">Green($countcolor5)</option>";
	    echo "<option value=\"yellow\">Yellow($countcolor6)</option>";
  ?>
</select>
</div>
...
$aaa=mysql_connect("localhost","root","system");
mysql_select_db("eshop",$aaa);
$qry=mysql_query("select * from products where dept='mobiles&tablets'");
while($row = mysql_fetch_array($qry))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$i=0;	
$flag=0;
	$fetch=mysql_query("select * from products where dept='mobiles&tablets'");
	...
	while($row = mysql_fetch_array($fetch))
	{
	 ...
	 echo "<img src=\"prodimg/$img1\" width=\"84%\" height=\"55%\" style=\"position:absolute; top:2%; left:6%;\">";
	if($flag==1)
	{
