...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive; color:#111;"><b>OS</b></p>
   ...
   $i1=0;
   $i2=0;
  $qry1=mysql_query("select * from products where subname='tablets' and category='android'");
...
$count1=count($prodname1);
 $qry1=mysql_query("select * from products where subname='tablets' and category='windows'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='tablets' and category='blackberry OS 7.0'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='tablets' and category='blackberry OS 7.1'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='tablets' and category='blackberry OS 10'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='tablets' and category='iOS 5'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='tablets' and category='iOS 6'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='tablets' and category='asha software platform 1.0'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Screen Size</b></p>
 ...
 $prodname4=array();
 $i1=0;
   $qry4=mysql_query("select * from products where subname='tablets' and size BETWEEN 6 AND 6.9");
  while($row = mysql_fetch_array($qry4))
{
 ...
 $qry4=mysql_query("select * from products where subname='tablets' and size BETWEEN 7 AND 7.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$stock=$row['stock'];
 ...
 $countsize2=count($prodname2);
  ...
  $qry4=mysql_query("select * from products where subname='tablets'  and size Between 8 AND 8.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$stock=$row['stock'];
 ...
 $countsize3=count($prodname3);
     ...
     $qry4=mysql_query("select * from products where subname='tablets' and size BETWEEN 9 AND 9.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$stock=$row['stock'];
 ...
 <?php
 echo "<option value=\"6-6.9\">6-6.9($countsize1)</option>";
  echo "<option value=\"7-7.9\">7-7.9($countsize2)</option>";
 echo "<option value=\"8-8.9\">8-8.9($countsize3)</option>";
 echo "<option value=\"9-9.9\">9-9.9($countsize4)</option>";
...
<div style="position:absolute; left:39.5%; top:2%; height:96%; width:0.3%; background-color:#F1F1F1;">
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry6=mysql_query("select * from products where subname='tablets' and brand='samsung'");
 while($row = mysql_fetch_array($qry6))
{
 ...
 $qry6=mysql_query("select * from products where subname='tablets' and brand='nokia'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countbrand2=count($prodname2);
   $qry6=mysql_query("select * from products where subname='tablets' and brand='micromax'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry6=mysql_query("select * from products where subname='tablets' and brand='sony'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry6=mysql_query("select * from products where subname='tablets' and brand='htc'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry6=mysql_query("select * from products where subname='tablets' and brand='blackberry'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry6=mysql_query("select * from products where subname='tablets' and brand='apple'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Price</b></p>
 ...
 $qry0=mysql_query("select * from products where subname='tablets' and discprice between 0 and 10000");
     while($row = mysql_fetch_array($qry0))
{
 ...
 $qry300=mysql_query("select * from products where subname='tablets' and discprice between 10001 and 20000");
     while($row = mysql_fetch_array($qry300))
{
 ...
 $qry300=mysql_query("select * from products where subname='tablets' and discprice between 20001 and 30000");
     while($row = mysql_fetch_array($qry300))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$countprice3=count($prodname3);
   ...
   $qry0=mysql_query("select * from products where subname='tablets' and discprice between 30001 and 40000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry0=mysql_query("select * from products where subname='tablets' and discprice between 40001 and 50000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry0=mysql_query("select * from products where subname='tablets' and discprice between 50001 and 60000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Color</b></p>
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry8=mysql_query("select * from products where subname='tablets'  and color='white'");
...
$qry8=mysql_query("select * from products where subname='tablets' and color='black'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='tablets' and color='blue'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='tablets' and color='red'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='tablets' and color='green'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='tablets' and color='yellow'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$aaa=mysql_connect("localhost","root","system");
mysql_select_db("eshop",$aaa);
$qry=mysql_query("select * from products where subname='tablets'");
while($row = mysql_fetch_array($qry))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$i=0;	
$flag=0;
	$fetch=mysql_query("select * from products where subname='tablets'");
