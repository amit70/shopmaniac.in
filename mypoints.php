...
<title>MyPoints : Shopmaniac.in</title>
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1009\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">MyPoints</p>
<hr/>
1. My Points are basially money points that you can be used for your shopping.<br/><br />
2. As soon as you register in our website your account will be updated with the sign up points.
<br/><br />
3. As Long as you continue shopping you amount will be converted into the points and wil get added to your &nbsp;&nbsp;&nbsp;&nbsp;sign up points (500).<br/><br />
4. After you reach a partiular target you will be given extra discount other than the disount that our &nbsp;&nbsp;&nbsp;&nbsp;website offers<br/><br />
5. Note:- This feature is not applicable for buying of Mobiles & Tablets.<br/><br />
6. For more discount shop more and get the benefits.
</div>
</div>
