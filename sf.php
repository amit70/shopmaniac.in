...
<form method="POST" action="http://localhost/shopmaniac/check.php"  name="login123">
  ...
  <td><?php 
  echo "<input type=\"text\" name=\"email123\" id=\"emil123\">";
  ?></td>
  </tr>
  <tr>
...
echo "<p style=\"position:absolute; left:0%; top:1%; font-family:'Comic Sans MS', cursive; font-weight:bold; font-size:150%;\">MEN'S SLIPPERS N FLIPFLOPS($count)</p><hr style=\"position:absolute; left:0%; top:85%; width:96%;\"/>";
?>
</div>
...
$q=0;
$i=0;	
	$fetch=mysql_query("select * from products where subname='slippers'");
