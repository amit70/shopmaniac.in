...
<title>MyCredits : Shopmaniac.in</title>
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1012\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">MyCredits</p>
<hr/>

1. My Credits are credits that you get instead of money when you return a product if the issue is from &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;your side.<br/><br />
2. You can then use your credits for further shopping at Shopmaniac.in.
<br/><br />
3. You can keep track of your credits in mycredits section of myaccount.
</div>
</div>
