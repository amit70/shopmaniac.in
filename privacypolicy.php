...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1002\" />";
  ?>
...
3. Your personal information such as Name,Email-Id,Telephone will be used for our internal proessing such as &nbsp;&nbsp;&nbsp;&nbsp;keeping you intouch with your produt,and for the daily updates.
</div>
</div>
