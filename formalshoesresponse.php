...
if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN    $arr[0] AND $arr[1] and  category='$cat' and color='$col' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN $arr[0] AND $arr[1] and  category='$cat' and color='$col' and size='$size1' and brand='$brand1'";
	$test=1;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and size='$size1' and brand='$brand1'";
	$test=2;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and category='$cat' and color='$col' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and category='$cat' and color='$col' and size='$size1' and brand='$brand1'";
	$test=3;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN    $arr[0] AND $arr[1] and category='$cat' and color='$col' and size='$size1'";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN $arr[0] AND $arr[1] and category='$cat' and color='$col' and size='$size1'";
	$test=4;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN    $arr[0] AND $arr[1] and category='$cat' and color='$col' and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN    $arr[0] AND $arr[1] and category='$cat' and color='$col' and brand='$brand1'";
	$test=5;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN    $arr[0] AND $arr[1] and color='$col' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and color='$col' and size='$size1' and brand='$brand1'";
	$test=6;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and color='$col' and brand='$brand1'";
	$qry2="select count(*) from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and color='$col' and brand='$brand1'";
	$test=7;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['color'],"Choose Color")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='formal shoes' and size='$size1' and  price BETWEEN  $arr[0] AND $arr[1] and color='$col'";
	$qry2="select count(*) from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and size='$size1' and color='$col'";
	$test=8;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and color='$col' and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and  color='$col' and size='$size1' and brand='$brand1'";
	$test=9;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and size='$size1' and brand='$brand1'";
	$test=10;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and color='$col'";
	$qry2="select count(*) from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and color='$col'";
	$test=11;
}
else if(strcmp($_POST['category'],"Choose Category")!=0&& strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and  category='$cat' and color='$col' and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and  category='$cat' and color='$col' and brand='$brand1'";
	$test=12;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and brand='$brand1'";
	$qry2="select count(*) from products  where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and brand='$brand1'";
	$test=13;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and  category='$cat' and color='$col' and size='$size1'";
	$qry2="select count(*) from products where subname='formal shoes' and   category='$cat' and color='$col' and size='$size1'";
	$test=14;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and size='$size1'";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and category='$cat' and size='$size1'";
	$test=15;
}
...
else if(strcmp($_POST['range'],"Price Range")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and color='$col'";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and color='$col'";
	$test=16;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and  color='$col' and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and  color='$col' and brand='$brand1'";
	$test=17;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['size1'],"Choose Size")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and  size='$size1' and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and  size='$size1' and brand='$brand1'";
	$test=18;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and brand='$brand1'";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1] and brand='$brand1'";
	$test=19;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and  category='$cat' and color='$col'";
	$qry2="select count(*) from products where subname='formal shoes' and  category='$cat' and color='$col'";
	$test=20;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes'  and price BETWEEN $arr[0] AND $arr[1] and  category='$cat'";
	$qry2="select count(*) from products where subname='formal shoes'  and price BETWEEN $arr[0] AND $arr[1] and  category='$cat'";
	$test=21;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['size1'],"Choose Size")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and  category='$cat' and size='$size1'";
	$qry2="select count(*) from products where subname='formal shoes' and  category='$cat' and size='$size1'";
	$test=22;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1]  and size='$size1'";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN  $arr[0] AND $arr[1]  and size='$size1'";
	$test=23;
}
else if( strcmp($_POST['size1'],"Choose Size")!=0 && strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where subname='formal shoes' and  color='$col' and size='$size1'";
	$qry2="select count(*) from products where  subname='formal shoes' and  color='$col' and size='$size1'";
	$test=24;
}
else if(strcmp($_POST['category'],"Choose Category")!=0 && strcmp($_POST['brand1'],"Choose Brand")!=0 )
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where  subname='formal shoes' and category='$cat' and brand='$brand1'";
	$qry2="select count(*) from products  where subname='formal shoes' and category='$cat' and brand='$brand1'";
	$test=25;
}
...
else if(strcmp($_POST['color'],"Choose Color")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where color='$col' and subname='formal shoes'";
	$qry2="select count(*) from products where color='$col' and subname='formal shoes'";
	$test=27;
}
else if(strcmp($_POST['brand1'],"Choose Brand")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where brand='$brand1' and subname='formal shoes'";
	$qry2="select count(*) from products where brand='$brand1' and subname='formal shoes'";
	$test=28;
}
else if(strcmp($_POST['size1'],"Choose Size")!=0)
{
	...
	$brand1=$_POST['brand1'];
	$range=$_POST['range'];
	$qry1="select * from products where size='$size1' and subname='formal shoes'";
	$qry2="select count(*) from products where size='$size1' and subname='formal shoes'";
	$test=29;
}
else if(strcmp($_POST['range'],"Price Range")!=0)
{
	...
	$range=$_POST['range'];
	$arr=spliti("-",$range);
	$qry1="select * from products where subname='formal shoes' and price BETWEEN $arr[0] AND $arr[1]";
	$qry2="select count(*) from products where subname='formal shoes' and price BETWEEN $arr[0] AND $arr[1]";
	$test=30;
}
else if(strcmp($_POST['category'],"Choose Category")!=0)
{
	$cat=$_POST['category'];
	$qry1="select * from products where category='$cat' and subname='formal shoes'";
	$qry2="select count(*) from products where category='$cat' and subname='formal shoes'";
	$test=31;
}
else if("Choose Category"==0 && "Choose Size"==0 && "Choose Brand"==0 && "Price Range"==0 && "Choose Color"==0)
{
	$qry1="select * from products where subname='formal shoes' ";
	$qry2="select count(*) from products where subname='formal shoes' ";
	$test=32;
}
?>
...
else if(strcmp($brand1,"bata")==0)
{
  echo "<option>Choose Brand</option>
  <option value=\"bata\" selected=\"selected\">Bata</option>
  <option value=\"carlton london\">CARLTON LONDON</option>";
}
else if(strcmp($brand1,"carlton london")==0)
{
  echo "<option>Choose Brand</option>
  <option value=\"bata\">Bata</option>
  <option value=\"carlton london\" selected=\"selected\">CARLTON LONDON</option>";
}
else
{
	echo "<option>Choose Brand</option>
