...
<form action="track.php" method="POST" name="trk" id="trk">
 ...
 <input type="text" name="oid"  id="oid" style="position:absolute; left:42%; top:67%; height:4%;">
 </form>
<?php
if($_SESSION['status']=="")
{
	echo "<p style=\"position:absolute; left:30%; top:82%; font-family:'Comic Sans MS', cursive; font-size:190%; \">".$_SESSION['status']."</p>";
...
?>
<a href="#" onclick="track()"><img src="prodimg/submit.png" width="12%" height="10%" style="position:absolute; left:40%; top:75%" onmousedown="this.src='prodimg/submit1.png'" onmouseup="this.src='prodimg/submit.png'"/>
</div>
</div>
