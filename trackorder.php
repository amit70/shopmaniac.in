...
<title>Track Order : Shopmaniac.in</title>
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1006\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">TRACK ORDER</p>
<hr/>
1. &nbsp;Tracking an ordering on the shopmanaic.in is very easy.<br /><br />
2. After placing the order you will have an Order Id<br /><br />
3. To find the Order Id go the myOrder section of MyAccount.

<p style="position:absolute; left:30%; top:60%; font-family:'Comic Sans MS', cursive; font-size:125%;">Order Id </p>

<form action="track.php" method="POST" name="trk" id="trk">
 <input type="text" name="oid"  id="oid" style="position:absolute; left:42%; top:66%; height:6%; width:30%;">
 </form>
<?php
if($_SESSION['status']=="")
{
	echo "<p style=\"position:absolute; left:25%; top:83%; font-family:'Comic Sans MS', cursive; font-size:170%; \">".$_SESSION['status']."</p>";
}
else
{
echo "<p style=\"position:absolute; left:25%; top:83%; font-family:'Comic Sans MS', cursive; font-size:170%; \">'".$_SESSION['status']."'</p>";
...
?>
<a href="#" onclick="track13()"><img src="prodimg/submit.png" width="12%" height="10%" style="position:absolute; left:40%; top:80%" onmousedown="this.src='prodimg/submit1.png'" onmouseup="this.src='prodimg/submit.png'"/></a>
</div>
</div>
