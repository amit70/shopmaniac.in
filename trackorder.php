...
<hr/>
1. &nbsp;Tracking an ordering on the shopmanaic.com is very easy.<br /><br />
2. After placing the order you will have an Order Id<br /><br />
3. To find the Order Id go the myOrder section of MyAccount.

<p style="position:absolute; left:30%; top:50%; font-family:'Comic Sans MS', cursive; font-size:125%;">Order Id </p>

<form action="track.php" method="POST" name="trk" id="trk">

 <input type="text" name="oid"  id="oid" style="position:absolute; left:42%; top:54.2%; height:4%;">
 </form>
<?php

echo "<p style=\"position:absolute; left:30%; top:75%; font-family:'Comic Sans MS', cursive; font-size:190%; \">".$_SESSION['status']."</p>";
?>
<a href="#" onclick="track()"><img src="prodimg/submit.png" width="10%" height="8%" style="position:absolute; left:40%; top:63%" onmousedown="this.src='prodimg/submit1.png'" onmouseup="this.src='prodimg/submit.png'"/>
</div>
</div>
