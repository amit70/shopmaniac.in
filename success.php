...
<p style="position:absolute; left:15%; top:48%; font-family:'Comic Sans MS', cursive; font-size:105%;">The product will be shipped to following address:- <b><?php
echo $addship;
?> </b></p>
...
<a href="home.php"><img src="prodimg/continueshopping.png" width="22%" height="12%" style="position:absolute; left:40%; top:103%;" onmousedown="this.src='prodimg/continueshopping1.png'" onmouseout="this.src='prodimg/continueshopping.png'"/></a>
</div>
</div>
