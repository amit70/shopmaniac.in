...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive; color:#111;"><b>OS</b></p>
   ...
   $i1=0;
   $i2=0;
  $qry1=mysql_query("select * from products where subname='mobiles' and category='android'");
...
$count1=count($prodname1);
 $qry1=mysql_query("select * from products where subname='mobiles' and category='windows'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='mobiles' and category='blackberry OS 7.0'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='mobiles' and category='blackberry OS 7.1'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='mobiles' and category='blackberry OS 10'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='mobiles' and category='iOS 5'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='mobiles' and category='iOS 6'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='mobiles' and category='asha software platform 1.0'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Screen Size</b></p>
 ...
 $prodname4=array();
 $i1=0;
   $qry4=mysql_query("select * from products where subname='mobiles' and size BETWEEN 2 AND 2.9");
  while($row = mysql_fetch_array($qry4))
{
 ...
 $qry4=mysql_query("select * from products where subname='mobiles' and size BETWEEN 3 AND 3.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$stock=$row['stock'];
 ...
 $countsize2=count($prodname2);
  ...
  $qry4=mysql_query("select * from products where subname='mobiles'  and size Between 4 AND 4.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$stock=$row['stock'];
 ...
 $countsize3=count($prodname3);
     ...
     $qry4=mysql_query("select * from products where subname='mobiles' and size BETWEEN 5 AND 5.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$stock=$row['stock'];
...
<div style="position:absolute; left:39.5%; top:2%; height:96%; width:0.3%; background-color:#F1F1F1;">
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry6=mysql_query("select * from products where subname='mobiles' and brand='samsung'");
 ...
 while($row = mysql_fetch_array($qry6))
{
 ...
 $countbrand2=count($prodname2);
   $qry6=mysql_query("select * from products where subname='mobiles' and brand='micromax'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry6=mysql_query("select * from products where subname='mobiles' and brand='sony'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry6=mysql_query("select * from products where subname='mobiles' and brand='htc'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry6=mysql_query("select * from products where subname='mobiles' and brand='blackberry'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry6=mysql_query("select * from products where subname='mobiles' and brand='apple'");
 while($row = mysql_fetch_array($qry6))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Price</b></p>
 ...
 $qry0=mysql_query("select * from products where subname='mobiles' and discprice between 0 and 10000");
     while($row = mysql_fetch_array($qry0))
{
 ...
 $qry300=mysql_query("select * from products where subname='mobiles' and discprice between 10001 and 20000");
     while($row = mysql_fetch_array($qry300))
{
 ...
 $qry300=mysql_query("select * from products where subname='mobiles' and discprice between 20001 and 30000");
     while($row = mysql_fetch_array($qry300))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$countprice3=count($prodname3);
   ...
   $qry0=mysql_query("select * from products where subname='mobiles' and discprice between 30001 and 40000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry0=mysql_query("select * from products where subname='mobiles' and discprice between 40001 and 50000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countprice5=count($prodname5);
  ...
  echo "<option value=\"30001-40000\">30001-40000($countprice4)</option>";
    echo "<option value=\"30001-40000\">40001-50000($countprice5)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Color</b></p>
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry8=mysql_query("select * from products where subname='mobiles'  and color='white'");
...
$qry8=mysql_query("select * from products where subname='mobiles' and color='black'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='mobiles' and color='blue'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='mobiles' and color='red'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='mobiles' and color='green'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry8=mysql_query("select * from products where subname='mobiles' and color='yellow'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countcolor6=count($prodname6);
  ...
  <?php
  echo "<option value=\"white\">White($countcolor2)</option>";
  echo "<option value=\"black\">Black($countcolor1)</option>";
...
$aaa=mysql_connect("localhost","root","system");
mysql_select_db("eshop",$aaa);
$qry=mysql_query("select * from products where subname='mobiles'");
while($row = mysql_fetch_array($qry))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$i=0;	
$flag=0;
	$fetch=mysql_query("select * from products where subname='mobiles'");
