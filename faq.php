...
<title>FAQ's : Shopmaniac.in</title>
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1005\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">FAQ'S</p>
<hr/>
&nbsp;&nbsp;&nbsp;1.&nbsp;<b>How to place order on our website?</b><br />
Ans.You can selet the product(s) you wish to buy , the product will be displayed on your My Trolley once &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;you complete your shopping , you can proceed to payment by signing up.<br /><br />
&nbsp;&nbsp;&nbsp;2.&nbsp;<b>How to return a product purchased from our website?</b><br />
Ans.You can return your product(s) within 30 days , if it has any faut or any defect  but it must be &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UNUSED. The refund will be in the form of credit points if the issue is from your side.<br /><br />
&nbsp;&nbsp;&nbsp;3.&nbsp;<b>What are credit points?</b><br />
Ans.Credit points can be used to purchase product(s) from our website.<br /><br />
&nbsp;&nbsp;&nbsp;4.&nbsp;<b>How do i pay for shopmaniac purchase?</b><br />
Ans.Basically there are four payment options, Credit card,Debit card,Netbanking and Cash on delivery.
