...
<title>Terms & Conditions : Shopmaniac.in</title>
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1004\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">Terms And Conditions</p>
<hr/>

Welcome to Shopmaniac.com wherein you can purchase clothes , shoes and etc. By joining our website you are bound to certain Terms & conditions.<br/><br />
1. Use of the Website—By accessing the website, you warrant and represent to the website owner that you &nbsp;&nbsp;&nbsp;are legally entitled to do so and to make use of information made available via the website.
<br /><br />
2. Trademarks—The trademarks, names, logos and service marks (collectively “trademarks”) displayed on this &nbsp;&nbsp;website are registered and unregistered trademarks of the website owner. Nothing contained on this &nbsp;&nbsp;&nbsp;&nbsp;website should be construed as granting any license or right to use any trademark without the prior written &nbsp;&nbsp;&nbsp;&nbsp;permission of the website owner.<br /><br />
...
<br /><br />
4. Warranties—The website owner makes no warranties, representations, statements or guarantees (whether &nbsp;&nbsp;&nbsp;&nbsp;express, implied in law or residual) regarding the website.<br /><br />
