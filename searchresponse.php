...
for($v=0;$v<count($q);$v++)
	{
   $qry1111="select * from products where pid=".(int)$q[$v];
...
for($v=0;$v<count($q);$v++)
	{
   $qry1234="select * from products where pid=".(int)$q[$v];
...
for($v=0;$v<count($q);$v++)
	{
   $qry12345="select * from products where pid=".(int)$q[$v];
...
if(strcmp($_SESSION['price'],"601-1000")==0)
{
	echo"<option>Price Range</option>
...
for($v=0;$v<count($q);$v++)
	{
   $qry123456="select * from products where pid=".(int)$q[$v];
...
if(strcmp($_SESSION['cat'],"Choose Category")!=0 && strcmp($_SESSION['size'],"Choose Size")!=0 && strcmp($_SESSION['brand'],"Choose Brand")!=0 && strcmp($_SESSION['price'],"Price Range")!=0 && strcmp($_SESSION['clr'],"Choose Color")!=0)
{
	...
	$qry1="select * from products where subname='".$_SESSION['cat']."' and size='".$_SESSION['size']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";
	$qry2="select count(*) from products where subname='".$_SESSION['cat']."' and size='".$_SESSION['size']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";																						$test=1;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where subname='".$_SESSION['cat']."' and size='".$_SESSION['size']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1]  and(";
	$qry2="select count(*) from products where subname='".$_SESSION['cat']."' and size='".$_SESSION['size']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and(";																						$test=2;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where subname='".$_SESSION['cat']."' and size='".$_SESSION['size']."' and  price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";
	$qry2="select count(*) from products where subname='".$_SESSION['cat']."' and size='".$_SESSION['size']."' and  price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";																						
																																										 $test=4;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where subname='".$_SESSION['cat']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";
	$qry2="select count(*) from products where subname='".$_SESSION['cat']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";																						$test=5;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where size='".$_SESSION['size']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";
	$qry2="select count(*) from products where size='".$_SESSION['size']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";																						$test=6;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where  brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";
	$qry2="select count(*) from products where  brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";																						$test=7;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where  size='".$_SESSION['size']."' and  price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";
	$qry2="select count(*) from products where  size='".$_SESSION['size']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";																						$test=8;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where  size='".$_SESSION['size']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1]  and(";
	$qry2="select count(*) from products where  size='".$_SESSION['size']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and (";																						$test=10;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where subname='".$_SESSION['cat']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";
	$qry2="select count(*) from products where subname='".$_SESSION['cat']."' and price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";																						$test=11;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where subname='".$_SESSION['cat']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1] and(";
	$qry2="select count(*) from products where subname='".$_SESSION['cat']."' and brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1]  and(";																						$test=13;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where subname='".$_SESSION['cat']."' and size='".$_SESSION['size']."'  and price between $arr[0] and $arr[1]  and(";
	$qry2="select count(*) from products where subname='".$_SESSION['cat']."' and size='".$_SESSION['size']."'  and price between $arr[0] and $arr[1]  and(";																						$test=15;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";
	$qry2="select count(*) from products where  price between $arr[0] and $arr[1] and color='".$_SESSION['clr']."' and(";																						$test=17;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where  brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1]  and(";
	$qry2="select count(*) from products where brand='".$_SESSION['brand']."' and price between $arr[0] and $arr[1]  and(";																						$test=20;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where subname='".$_SESSION['cat']."' and  price between $arr[0] and $arr[1]  and(";
	$qry2="select count(*) from products where subname='".$_SESSION['cat']."' and price between $arr[0] and(";																						$test=22;
...
{
	$arr=spliti("-",$_SESSION['price']);
	$qry1="select * from products where  size='".$_SESSION['size']."'  and price between $arr[0] and $arr[1]  and(";
	$qry2="select count(*) from products where  size='".$_SESSION['size']."'  and price between $arr[0] and $arr[1]  and(";																						$test=24;
...
else if(strcmp($_SESSION['price'],"Price Range")!=0)
{
	...
	$qry1="select * from products where price between $arr[0] and $arr[1] and (";
	$qry2="select count(*) from products where price between $arr[0] and $arr[1] and (";														   $test=30;
	for($i=0;$i<count($q);$i++)
	{
		if($i!=count($q)-1)
		{
...
echo "<p style=\"position:absolute; left:0%; top:-40%; font-family:'Comic Sans MS', cursive; font-weight:bold; font-size:150%;\">'".$_SESSION['item']."'</p>";

echo "<p style=\"position:absolute; left:0%; top:10%; font-family:'Comic Sans MS', cursive; font-weight:bold; font-size:150%;\">WE FOUND ($count) PRODUCTS</p><hr style=\"position:absolute; left:0%; top:85%; width:96%;\"/>";
?>
</div>
