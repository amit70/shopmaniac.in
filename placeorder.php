...
<title>Place Order : Shopmaniac.in</title>
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1007\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">Place Order</p>
<hr/>
1. &nbsp;You Can Easyily place an order on Shopmaniac.in.<br /><br />
2. You can select a product(s) of your choice from menu as well as from home page.<br /><br />
3. You will then be redirected to the product Information page where you can select your appropriate &nbsp;&nbsp;&nbsp;&nbsp;size as well as view full information of the product.<br /><br />
4. The product then enters in your trolley from where you can prooceed to the payment section.<br /><br />
5. On the payment page you will have to provide your shipping details and then  confirm.<br /><br />
6. You can check your ordered product from myorder section of myaccount.
</div>
</div>
