...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"15\" />";
  ?>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive; color:#111;"><b>OS</b></p>
   ...
   $i1=0;
   $i2=0;
  $qry1=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and category='blackberry OS 7.0'");
...
$count1=count($prodname1);
  ...
  $qry1=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and category='blackberry OS 7.1'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$qry1=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and category='blackberry OS 10'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$count3=count($prodname3);
 ...
 <?php 
 echo "<option value=\"blackberry OS 7.0\" >Blackberry OS 7.0($count1)</option>";
 echo "<option value=\"blackberry OS 7.1\" >Blackberry OS 7.1($count2)</option>";
 echo "<option value=\"blackberry OS 10\" >Blackberry OS 10($count3)</option>";
    ?>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Screen Size</b></p>
 ...
 $i1=0;
   ...
   $qry4=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and size BETWEEN 2 AND 2.9");
  while($row = mysql_fetch_array($qry4))
{
 ...
 $countsize1=count($prodname1);
  ...
  $qry4=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and size BETWEEN 3 AND 3.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 $countsize2=count($prodname2);
  ...
  $qry4=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and size Between 4 AND 4.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 $countsize3=count($prodname3);
     ...
     $qry4=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and size BETWEEN 5 AND 5.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
...
<p style="position:absolute; left:10%; top:3%;font-family:'Comic Sans MS', cursive;"><b>Brand</b></p>
  ...
  <?php
  echo "<option value=\"blackberry\">Blackberry ($count6)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Price</b></p>
  ...
  $prodname1=array();
   ...
   $i1=0;
   $i2=0;
  $qry300=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and discprice between 20000 and 30000");
...
$qry300=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and discprice between 10001 and 20000");
     while($row = mysql_fetch_array($qry300))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $count3001=count($prodname2);
  ...
  $qry0=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and discprice between 0 and 10000");
     while($row = mysql_fetch_array($qry0))
{
 ...
 $qry0=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and discprice between 40001 and 50000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $count302=count($prodname4);
 
 $qry0=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and discprice between 30001 and 40000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $count303=count($prodname4);
  ...
  echo "<option value=\"30001-40000\">30001-40000($count303)</option>";
    //echo "<option value=\"40001-50000\">40001-50000($count302)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Color</b></p>
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry8=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and color='white'");
...
$qry8=mysql_query("select * from products where subname='mobiles' and brand='blackberry' and color='black'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$aaa=mysql_connect("localhost","root","system");
mysql_select_db("eshop",$aaa);
$qry=mysql_query("select * from products where subname='mobiles' and brand='blackberry'");
while($row = mysql_fetch_array($qry))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$i=0;	
$flag=0;
	$fetch=mysql_query("select * from products where subname='mobiles' and brand='blackberry'");
