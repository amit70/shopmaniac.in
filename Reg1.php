...
<form method="POST" action="http://localhost/shopmaniac/check.php"  name="login123">
 ...
 <p style="position:absolute; left:2%; top:60% ; color:#F00; font-family:'Comic Sans MS', cursive;" ></p>
 <a href="#" onclick="login1()"><img src="prodimg/Login1.png" width="45%" height="11%" style="position:absolute; left:27%; top:93%;" onmousedown="this.src='prodimg/Login2.png'" onmouseup="this.src='prodimg/Login1.png'"/></a>
</form>
</div>
...
<form method="POST" action="http://localhost/shopmaniac/Divert.php" name="register" >
  ...
  ?></td>
   ...
   <p style="position:absolute; left:2%; top:81% ; color:#F00; font-family:'Comic Sans MS', cursive;" >Username already exists</p>
  
<a href="#" onclick="reg1()"><img src="prodimg/Register1.png" width="40%" height="10%" style="position:absolute; left:27%; top:90%;" onmousedown="this.src='prodimg/Register2.png'" onmouseup="this.src='prodimg/Register1.png'"/></a>
</form>
</div>
</div>
