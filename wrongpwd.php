...
<?php
   echo $_SESSION['uname'];
   ?>
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">Login</p>
<div id="error" style="position:absolute; left:0%; top:20%; width:100%; height:15%; border-style:ridge; background-color:#FF8080; border-color:#F00;">
<p style="position:absolute; left:10%; top:10%; font-family:'Comic Sans MS', cursive; color:#000;">Please Enter Correct Username or Password</p>
</div>
...
<p style="position:absolute; left:30%; top:60%;">Password:-</p><input type="password" name="pwd123" id="pwd123"  style="position:absolute; left:43%; top:63%; width:25%; height:5%;"/>
 ...
 <p style="position:absolute; left:38%; top:80%; font-family:'Comic Sans MS', cursive;color:#6D6D6D;">Dont't have an account Click <a href="#" onclick="logtr()" style="text-decoration:none; color:#2E2E2E;" onmouseover="this.style.color='#DF7000'" onmouseout="this.style.color='#2E2E2E'">HERE</a></p> 
  ...
  <a href="#" onclick="login1()"><img src="prodimg/Login1.png" width="25%" height="15%" style="position:absolute; left:40%; top:94%;" onmousedown="this.src='prodimg/Login2.png'" onmouseup="this.src='prodimg/Login1.png'"/></a>
   <?php
