...
if(strcmp($aaa,"Choose Category")!=0)
{
	$qq=spliti(",",$aaa);
	echo implode(",",$qq);
	$qry1="select * from products where category='$qq[1]'  ";
	$qry2="select count(*) from products where category='$qq[1]'";
}
else if(strcmp($bbb,"Choose Size")!=0)
{
	$rr=spliti(",",$bbb);
	$qry1="select * from products where size='$rr[1]'";
	$qry2="select count(*) from products where size='$rr[1]'";
}
