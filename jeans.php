...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive; color:#111;  font-family:'Comic Sans MS', cursive;"><b>Size</b></p>
...
$aaa=mysql_connect("localhost","root","system");
mysql_select_db("eshop",$aaa);
$qry=mysql_query("select count(*) from products where subname='jeans'");
while($row = mysql_fetch_array($qry))
{
	$count=$row['count(*)'];
}
