...
<title>Review : Shopmaniac.in</title>
...
function submit()
{
	var x=document.forms["review1"]["title"].value;
	if(x=="" || x==null)
	{
		alert("Please Enter the Title for your Review");
		return false;
	}
	var y=document.forms["review1"]["desc"].value;
	if(y=="" || y==null)
	{
		alert("Please Enter the Description for your Review");
		return false;
	}
...
function off(me)
{
	if(!rated)
	{
		...
		{
			rating(preSet);
			//document.getElementById("rateStatus").innerHTML = document.getElementById

//("ratingSaved").innerHTML;
		}
	}
}
...
//("ratingSaved").innerHTML + " :: "+me.title;
		preSet = me;
		rated=1;
		sendRate(me);
		rating(me);
...
function sendRate(sel)
{
	...
	document.getElementById("rate").value=sel.title;
}
//--------------------------------------------------------------------------------------
function aaa(amit)
{
...
#rateStatus{float:left; clear:both; width:100%; height:20px; }
    #review{position:absolute; width:30%; height:3%;left:44%;top:69%;}
    #review li{float:left;list-style:none;}
    #review li a:hover,
    #review .on{background:url(prodimg/star5.jpg) no-repeat;}
    #review a{float:left;background:url(prodimg/star0.jpg) no-repeat; width:20%; height:1000%;}
...
$pname=$_POST['pname'];
?>
<p style="position:absolute; left:10%; top:2%; font:'Comic Sans MS', cursive;">PLEASE PROVIDE YOUR VALUABLE REVIEW/COMMENT for <?php
echo "'<b>$pname</b>'";
?></p>
<div id="apDiv45">
<form method="post" action="rateinsert.php" id="review1" name="review1">
<table border="0"  cellspacing="20" style="position:absolute; left:17%; top:1%;">
<tr>
<td height="80"><font size="5%" >Username:</font>
</td>
<td height="80" ><?php
echo "<input type=\"text\" name=\"username\" value=".$_SESSION['uname']." ></td>"
?>
</tr>
<tr>
<td height="80"><font size="5%" >Title:</font>
</td>
<td height="80"><?php
echo "<input type=\"text\" name=\"title\" value=\"\" style=\"width:120%; height:35%\"/></td>"
?>
</tr>
<tr>
<td height="80"><font size="5%" >Description:</font></td>
<td height="80">
<?php
echo "<textarea name=\"desc\" style=\" width:200%; height:100%;\"></textarea>";
?>
</td>
</tr>
<tr>
<td height="80"><font size="5%" >Rate:</font></td>
</tr>
</table>
...
<span id="ratingSaved"></span>
	<div id="review" title="Rate Me">
		<a onclick="rateIt(this)" id="_1" title="Worst" onmouseover="rating(this)" onmouseout="off(this)"></a>
    <a onclick="rateIt(this)" id="_2" title="Not Bad" onmouseover="rating(this)" onmouseout="off(this)"></a>
    <a onclick="rateIt(this)" id="_3" title="Mediocre" onmouseover="rating(this)" onmouseout="off(this)"></a>
    <a onclick="rateIt(this)" id="_4" title="Pretty Good" onmouseover="rating(this)" onmouseout="off(this)"></a>
    <a onclick="rateIt(this)" id="_5" title="Excellent" onmouseover="rating(this)" onmouseout="off(this)"></a>
	</div>
    <?php
    echo "<input type=\"hidden\" id=\"rate\" value=\"\" name=\"abc\"/>";
	echo "<input type=\"hidden\"  value=\"$pid\" name=\"prodid\"/>";
	?>
    
    
</form>

<a href="#" onclick="submit()"> <img src="prodimg/submit.png" width=25%" height="10%" style="position:absolute; left:40%; top:85%;" onmousedown="this.src='prodimg/submit1.png'" onmouseup="this.src='prodimg/submit.png'"/></a>
</div>
</div>
