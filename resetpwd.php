...
function continue1()
{
	var z=document.forms["resetpass"]["newpwd"].value;
	var a=z.length;
	  if (z==null || z=="")
  {
  ...
  var z1=document.forms["resetpass"]["confirmpwd"].value;
	if (z1==null || z1=="")
  {
  ...
  if(a<8)
  {
	 alert("Your Passoword should be of 8 characters");
   	 return false; 
  }
  
  if(z!==z1)
  {
	 alert("Passowrd and Confirm Passowrd does not match"); 
	 return false;
  }
...
<hr/>
<form action="insertpwd.php" name="resetpass" id="resetpass" method="post">
<p style="position:absolute; left:20%; top:20%; font-family:'Comic Sans MS', cursive;">New Password</p><input type="password" name="newpwd" value="" style="position:absolute; left:40%; top:25%;"/>

<p style="position:absolute; left:20%; top:36%; font-family:'Comic Sans MS', cursive;">Confirm Password</p><input type="password" name="confirmpwd" value="" style="position:absolute; left:40%; top:40%;"/>



<a href="#" onclick="continue1()"><img src="prodimg/continue.png" width="15%" height="12%" style="position:absolute; left:40%; top:55%" onmousedown="this.src='prodimg/continue1.png'" onmouseup="this.src='prodimg/continue.png'"></a>
<?php
...
if($flag==1)
{
	echo "<img src=\"prodimg/rigthtick.jpg\" width=\"3%\" height=\"4%\" style=\"position:absolute; left:25%; top:74%;\"/>";
	echo "<p style=\"position:absolute; left:30%; top:70%; color:#f00;\">Your Passsowrd has been Updated Successfully</p>";
	
	echo "<a href=\"index.php\"><img src=\"prodimg/backtoshop.png\" style=\"position:absolute; left:38%; top:83%;width:20%;height:11%\" onmousedown=\"this.src='prodimg/backtoshop1.png'\" onmouseup=\"this.src='prodimg/backtoshop.png'\" /></a>";	
}
else
{
	if($flag!="")
	{
	echo "<img src=\"prodimg/wrongtick.jpg\" width=\"3%\" height=\"4%\" style=\"position:absolute; left:25%; top:74%;\"/>";
	echo "<p style=\"position:absolute; left:30%; top:70%; color:#f00;\">It seems this EmailId is not registered with us.</p>";
	echo "<a href=\"index.php\"><img src=\"prodimg/backtoshop.png\" style=\"position:absolute; left:38%; top:83%;width:20%;height:11%\" onmousedown=\"this.src='prodimg/backtoshop1.png'\" onmouseup=\"this.src='prodimg/backtoshop.png'\" /></a>";
	}
}
?>
