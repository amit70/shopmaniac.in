...
<title>Shipping Policy : Shopmaniac.in</title>
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1003\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">Shipping Policy</p>
<hr/>
1. We provide 'FREE SHIPPING' all over India.<br/><br />
2. Delivery will be done in 2-4 buisness days or in extreme case it can be extended	.Suggest the time you &nbsp;&nbsp;&nbsp;&nbsp;want your product to be delivered at your place. <br /><br />
3. For any kind of help for the shipping policy you can contact on our helpline number 9773436955(24x7) &nbsp;&nbsp;&nbsp;&nbsp;or  drop a mail to amit.rajula@gmail.com.
</div>
</div>
