...
<title>Contact Us : Shopmaniac.in</title>
...
function querysubmit()
{
	...
	b=document.getElementById('specify').value;
...
<form method="POST" action="check.php"  name="login123">
  ...
  <?php
  echo "<input type=\"hidden\" name=\"flag\" value=\"1010\" />";
  ?>
...
<div id="apDiv44">
<div id="apDiv45">
<p style="font-family:'Comic Sans MS', cursive; font-size:125%; text-align:center;">CONTACT US</p>
<hr/>
<center><b>Customer Care:-</b><br />
<font size=2>Call us at 9773436955 (avaliable 24x7).<br />	
Mail us at support@shopmaniac.in</font>
<br /><br />
<b><font size=3 >Have any Query?</font></b><br />
<b><font size=2>Fill the form below. Your queries will be answered within 24 hours.</font></b>
<?php
$flag=$_GET['flag'];
if($_SESSION['uname']=="")
{	echo "<br />";
	echo "<b><font size=\"2\">*(PLease LogIn To Enter Your Feedback)*</font></b>";
	echo "<br /><br />";
//echo "<form method=\"post\" action=\"http://localhost/shopmaniac/querypost.php\">";
echo "<table cellspacing=\"15\">";
echo "<tr>";
echo "<td>Your e-mail address: </td><td><input type=\"text\" name=\"email\" disabled=\"disabled\"></td>";
echo "</tr>";
echo "<tr>";
echo "<td>Category: </td>";
echo "<td><select disabled=\"disabled\">";
...
echo "</select></td></tr>";
echo "<tr><td>Specify your query:</td>";
echo "<td><textarea rows=5 cols=30 disabled=\"disabled\"></textarea></td></tr>";
echo "</table>";

//<input type="submit" value="Submit Query" name="submit">
echo "<a href=\"#\" onclick=\"logtr()\"><img src=\"prodimg/submitquery.png\" width=\"150\" height=\"50\" onmousedown=\"this.src='prodimg/submitquery1.png'\" onmouseup=\"this.src='prodimg/submitquery.png'\"></a>";
//echo "</form>";
}
else
{
	...
	if($flag==1)
	{
	echo "<b><font size=\"2\" color=\"#FF0000\">Your Query has been submitted Successfully</font></b>";
	}
	echo "<br /><br />";
	echo "<form method=\"post\" action=\"http:querypost.php\" name=\"query\" id=\"query\">";
echo "<table cellspacing=\"15\">";
echo "<tr>";
echo "<td>Your e-mail address: </td><td><input type=\"text\" name=\"email\" value=\"$email\" disabled=\"disabled\"></td>";
echo "</tr>";
echo "<tr>";
echo "<td>Category: </td>";
...
echo "</select></td></tr>";
echo "<tr><td>Specify your query:</td>";
echo "<td><textarea rows=5 cols=30 name=\"specify\" id=\"specify\"></textarea></td></tr>";
echo "</table>";
//<input type="submit" value="Submit Query" name="submit">
echo "<a href=\"#\" onclick=\"querysubmit()\"><img src=\"prodimg/submitquery.png\" width=\"150\" height=\"50\" onmousedown=\"this.src='prodimg/submitquery1.png'\" onmouseup=\"this.src='prodimg/submitquery.png'\"></a>";
