...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive; color:#111;"><b>OS</b></p>
   ...
   $i1=0;
   $i2=0;
  $qry1=mysql_query("select * from products where subname='tablets' and brand='apple' and category='iOS 5'");
...
$qry1=mysql_query("select * from products where subname='tablets' and brand='apple' and category='iOS 6'");
 while($row = mysql_fetch_array($qry1))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$count2=count($prodname2);
 ...
 <?php 
 //echo "<option value=\"iOS 5\" >iOS 5($count1)</option>";
 echo "<option value=\"iOS 6\" >iOS 6($count2)</option>";
    ?>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Screen Size</b></p>
 ...
 $prodname3=array();
 $i1=0;
  $qry4=mysql_query("select * from products where subname='tablets' and brand='apple' and size BETWEEN 7 AND 7.9");
  while($row = mysql_fetch_array($qry4))
{
 ...
 $count4=count($prodname1);
  ...
  $qry4=mysql_query("select * from products where subname='tablets' and brand='apple' and size Between 9 AND 9.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 $count5=count($prodname2);
     ...
     $qry4=mysql_query("select * from products where subname='tablets' and brand='apple' and size BETWEEN 5 AND 5.9");
  while($row = mysql_fetch_array($qry4))
{
	//$name= $row['pname'];
	$name= $row['pname'];
 ...
 <?php
  echo "<option value=\"7-7.9\">7-7.9($count4)</option>";
 echo "<option value=\"9-9.9\">9-9.9($count5)</option>";
...
<p style="position:absolute; left:10%; top:3%;font-family:'Comic Sans MS', cursive;"><b>Brand</b></p>
  ...
  <?php
  echo "<option value=\"apple\">Apple ($count6)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Price</b></p>
  ...
  $prodname1=array();
   ...
   $i1=0;
   $i2=0;
  $qry300=mysql_query("select * from products where subname='tablets' and brand='apple' and discprice between 20001 and 30000");
...
$qry300=mysql_query("select * from products where subname='tablets' and brand='apple' and discprice between 30001 and 40000");
     while($row = mysql_fetch_array($qry300))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $countprice2=count($prodname2);
  ...
  $qry0=mysql_query("select * from products where subname='tablets' and brand='apple' and discprice between 40001 and 50001");
     while($row = mysql_fetch_array($qry0))
{
 ...
 $qry0=mysql_query("select * from products where subname='tablets' and brand='apple' and discprice between 50001 and 60000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 $qry0=mysql_query("select * from products where subname='tablets' and brand='apple' and discprice between 40001 and 50000");
     while($row = mysql_fetch_array($qry0))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
 ...
 // echo "<option value=\"0-10000\">0-10000($count0)</option>";
  ...
  echo "<option value=\"20001-30000\">20001-30000($countprice1)</option>";
  echo "<option value=\"30001-40000\">30001-40000($countprice2)</option>";
   echo "<option value=\"40001-50000\">40001-50000($countprice3)</option>";
      echo "<option value=\"40001-50000\">50001-60000($countprice4)</option>";
  ?>
</select>
...
<p style="position:absolute; left:10%; top:3%; font-family:'Comic Sans MS', cursive;"><b>Color</b></p>
 ...
 $prodname1=array();
   ...
   $i2=0;
      $i3=0;
  $qry8=mysql_query("select * from products where subname='tablets' and brand='apple' and color='white'");
...
$qry8=mysql_query("select * from products where subname='tablets' and brand='apple' and color='black'");
   while($row = mysql_fetch_array($qry8))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$aaa=mysql_connect("localhost","root","system");
mysql_select_db("eshop",$aaa);
$qry=mysql_query("select * from products where subname='tablets' and brand='apple'");
while($row = mysql_fetch_array($qry))
{
	//$count=$row['count(*)'];
	$name= $row['pname'];
...
$i=0;	
$flag=0;
	$fetch=mysql_query("select * from products where subname='tablets' and brand='apple'");
